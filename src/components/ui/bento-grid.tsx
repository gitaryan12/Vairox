...
export const CARDS = [
    {
        ...
        description: "Create shorts that are easy to remember and share.",
        href: "#",
        cta: "Learn more",
        ...
        background: (
            <Card className="absolute top-10 left-10 origin-top rounded-none rounded-tl-md transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_100%)] group-hover:scale-105 border border-border border-r-0">
                <CardHeader>
                    ...
                    <CardDescription>
                        Find Precise Audience and Customer for your content.
                    </CardDescription>
                </CardHeader>
    ...
    },
    {
        ...
        description: "Quickly find the flows you need with AI-powered search.",
        href: "#",
        cta: "Learn more",
        ...
        background: (
            <Command className="absolute right-10 top-10 w-[70%] origin-to translate-x-0 border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-2">
                ...
                <div className="mt-1 cursor-pointer">
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Vairox.io/hdf00c</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Vairox.io/sdv0n0</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Vairox.io/03gndo</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Vairox.io/09vmmw</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Vairox.io/s09vws</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Vairox.io/sd8fv5</div>
                </div>
            </Command>
        ),
    },
    ...
    },
    {
        Icon: CalendarIcon,
        name: "Calendar",
        description: "Keep track of your sales and leads with our calendar view.",
        className: "col-span-3 lg:col-span-1",
        href: "#",
        cta: "Learn more",
        background: (
