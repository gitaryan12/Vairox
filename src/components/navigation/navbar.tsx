      ...
      <AnimationContainer reverse delay={0.1} className="size-full">
        <MaxWidthWrapper className="flex items-center justify-between">
          <div className="flex items-center space-x-12">
            <Link
              href="/#home"
              className="bg-black/30 flex items-center space-x-12 border border-white/10 rounded-2xl px-1 py-1 hover:bg-white/5 transition-all duration-200 ease-out"
            >
              <Image
                src="/icons/logo.png"
                alt="logo"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <p className="text-sm leading-tight text-muted-foreground">
                                      Manage sales, track performance, and more.
                                    </p>
                                  </Link>
                                </NavigationMenuLink>
                              </li>
