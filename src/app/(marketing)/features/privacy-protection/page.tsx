        ...
        <AnimationContainer delay={0.1} className="w-full">
          <div className="flex flex-col items-center justify-center py-10 max-w-lg mx-auto">
            ...
            <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
              With Vairox, safeguard your sensitive sales and lead information
              with advanced password protection and privacy-first tools. Stay
              secure while growing your business.
            </p>
            <div className="flex items-center justify-center gap-x-4 mt-8">
              <Button size="sm" asChild>
                <Link href="/dashboard">Start Securing Your Leads</Link>
              </Button>
              <Button size="sm" variant="outline" asChild>
                <Link href="/blog">Learn More About Privacy and Security</Link>
              </Button>
            </div>
          </div>
        </AnimationContainer>
          ...
          <LampContainer className="min-w-full mx-auto">
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              ...
              <p className="text-muted-foreground mt-6 max-w-lg mx-auto text-base md:text-lg">
                With Vairox, you can protect your leads and sales data with
                cutting-edge security, ensuring your business stays safe while
                maximizing growth.
              </p>
              <div className="mt-6">
                <Button asChild>
