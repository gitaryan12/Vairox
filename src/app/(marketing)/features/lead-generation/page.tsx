        ...
        <AnimationContainer delay={0.1} className="w-full">
          <div className="flex flex-col items-center justify-center py-10 max-w-xl mx-auto">
            ...
            <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
              Vairox powers your lead management with AI-driven insights.
              Shorten, track, and optimize links to maximize lead generation.
            </p>
            <div className="flex items-center justify-center gap-x-4 mt-8">
              <Button size="sm" asChild>
                <Link href="/dashboard">Leads Gen</Link>
              </Button>
          ...
          <LampContainer className="min-w-l mx-auto">
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              ...
              <p className="text-muted-foreground mt-6 max-w-lg mx-auto text-base md:text-lg">
                With Vairox’s AI-powered lead optimization, unlock powerful
                insights and drive quality leads faster than ever before.
              </p>
              <div className="mt-6">
                <Button asChild>
